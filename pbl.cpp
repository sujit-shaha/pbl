...
class BloodBank {
	public:
		...
		void display() {
			...
			while (getline(fin, line)) {
				...
				if (fin >> name >> blood >> qty >> age >> mobile_no >> city) {
					m[blood].push_back("Name: " + name + " | Blood Group: " + blood + " | Quantity: " + to_string(qty) + " | Age: " + to_string(age) + " | Mobile no.: " + mobile_no + " | City: " + city);
				}
			}

			cout << "------------------------------------------------------" << endl;
			cout << "List of Donors in the Blood Bank:" << endl;
			cout << "------------------------------------------------------" << endl;

			for (const auto &entry : m) {
				cout << "Blood Group: " << entry.first << endl;
		...
		void displayQuantity() {
			...
			cout << "------------------------------------------------------" << endl;
			cout << "Blood Group Donors in the Blood Bank:" << endl;
			cout << "------------------------------------------------------" << endl;

			for (const auto &entry : blooodGroup) {
...
int main() {
	...
	ifstream fin;
	ofstream fout;
	array<string, 8> arr = {"A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-"};


	cout << "---------------------------------------------" << endl;
	cout << "Welcome to the Blood Bank Management System" << endl;
	cout << "---------------------------------------------" << endl;
